...
public class MotionRender : ScriptableRendererFeature
{
    #region DEFINE
    [System.Serializable]
    ...
    class MotionVectorPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (this.blitMaterial == null)
                return;
#endif
            var volumeComponent = VolumeManager.instance.stack.GetComponent<MotionFeature>();
            ...
            using (new ProfilingScope(cmd, profilingSampler))
            {
                ...
                drawingSettings.perObjectData |= PerObjectData.MotionVectors; // MotionVector�L����
    ...
    {
        this.motionVectorPass.ConfigureTarget(renderer.cameraColorTarget, renderer.cameraDepthTarget);
        renderer.EnqueuePass(this.motionVectorPass);
        this.motionBlurPass.ConfigureTarget(renderer.cameraColorTarget, renderer.cameraDepthTarget);
